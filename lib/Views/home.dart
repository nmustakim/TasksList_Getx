    ...
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child: SizedBox(child: Column(children: [
          ...
          ElevatedButton(onPressed: ()=>Get.to(TodoHome(name: name.text,)),style: ElevatedButton.styleFrom(backgroundColor: Colors.cyanAccent,foregroundColor: Colors.black,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15))), child: const Text('Let\'s Start >'),)
        ],),),
      ),
    );
  }
